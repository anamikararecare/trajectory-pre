#!/usr/bin/env bash
# Canonical Q1 generator. Only mechanical incompleteness is a hard failure;
# all model/judge quality measurements are retained as diagnostics.
set -Eeuo pipefail
...
python -u -m src.q1.q1_mechanical_gate_cli generate \
