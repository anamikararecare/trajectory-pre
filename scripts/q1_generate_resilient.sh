#!/usr/bin/env bash
# Canonical Q1 generator: verbose, access-adjusted, and non-blocking for all
# behavioral/annotation quality diagnostics.
set -Eeuo pipefail
...
python -u -m src.q1.q1_resilient_cli generate \
